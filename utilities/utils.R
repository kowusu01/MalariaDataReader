...
ISSUE_CODE_COUNTRY_NOT_PRESENT <- "COUNTRY_NOT_PRESENT"
ISSUE_CODE_REGION_NOT_PRESENT <- "REGION_NOT_PRESENT"
ISSUE_CODE_YEAR_NOT_PRESENT <- "YEAR_NOT_PRESENT"

ISSUE_CODE_COUNTRY_INVALID <- "COUNTRY_INVALID"
ISSUE_CODE_REGION_INVALID <- "REGION_INVALID"
ISSUE_CODE_YEAR_INVALID <- "YEAR_INVALID"

ISSUE_CODE_NUM_CASES_ZERO_OR_NULL <- "NUM_CASES_ZERO_OR_NULL"
ISSUE_CODE_NUM_DEATHS_ZERO_OR_NULL <- "NUM_DEATHS_ZERO_OR_NULL"
ISSUE_CODE_NUM_CASES_INVALID <- "NUM_CASES_INVALID"
ISSUE_CODE_NUM_DEATHS_INVALID <- "NUM_DEATHS_INVALID"

ISSUE_CODE_NUM_DEATHS_GREATER_THAN_CASES <- "DEATHS_GREATER_THAN_CASES"
ISSUE_CODE_COUNTRY_REGION_MISMATCH <- "COUNTRY_REGION_MISMATCH"
